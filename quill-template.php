...
$url = 'https://leafydoc.getheally.com/patient_admin/prefill?redirect=sched&'. http_build_query($utm_params) .'&preset='.$base64_encoded_data;
...
wp_redirect('/get-started/intake');
